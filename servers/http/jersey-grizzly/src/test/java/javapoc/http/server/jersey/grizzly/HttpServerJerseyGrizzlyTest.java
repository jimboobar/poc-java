 ...
 */
public class HttpServerJerseyGrizzlyTest {
    ...
    public void shouldBeTree() throws IOException {
        try (HttpServerJerseyGrizzly server = new HttpServerJerseyGrizzly(URI.create("http://localhost:6789"))
                .map("/tree", new ResourceConfig(TreeResource.class))) {
